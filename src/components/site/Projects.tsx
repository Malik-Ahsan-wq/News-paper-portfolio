...
export function Projects() {
  ...
  return (
    <section id="work" className="border-b border-ink/80 bg-paper-alt" aria-labelledby="work-title">
      <motion.div
        variants={stagger}
        initial="hidden"
        whileInView="show"
      ...
      >
        <motion.div variants={fadeUp} className="mb-8 flex items-baseline justify-between border-b border-ink pb-2">
          <h2 id="work-title" className="font-display text-3xl font-black uppercase tracking-[0.05em] sm:text-4xl">
            Featured Stories
          </h2>
          <span className="eyebrow text-muted-foreground">Selected work · 2019—2026</span>
        </motion.div>
